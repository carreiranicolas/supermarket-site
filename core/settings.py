...
TEMPLATES = [
    {
        ...
        # Como usamos templates fora dos apps (na raiz do projeto),
        # usamos essa configutação abaixo. Ai o Django procura templates
        # também neste caminho e não só em apps
...
# Diz ao Django para buscar estáticos também na pasta /static/ da raiz
# (ele busca por padrão nos apps)
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
